...
/// 加载场景完成事件。
/// </summary>
public sealed class LoadSceneCompleteEventArgs : GameEventArgs
{
    /// <summary>
    /// 加载场景完成事件编号。
    /// </summary>
    ...
    /// <returns>创建的加载场景完成事件。</returns>
    public static LoadSceneCompleteEventArgs Create()
    {
        LoadSceneCompleteEventArgs loadSceneSuccessEventArgs = ReferencePool.Acquire<LoadSceneCompleteEventArgs>();
