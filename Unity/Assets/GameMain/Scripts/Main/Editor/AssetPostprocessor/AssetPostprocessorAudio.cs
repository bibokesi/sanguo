...
namespace GameMain.Editor
{
    public class AssetPostprocessorAudio : AssetPostprocessor
    {
        private void OnPreprocessAudio()
        {
            ...
            if (assetPath.Contains("Assets/GameMain/BaseAssets/Sounds/MusicSounds"))
            {
                //加载方式选择
            ...
            }else if (assetPath.Contains("Assets/GameMain/BaseAssets/Sounds/UISounds"))
            {
                //加载方式选择
                audioSetting.loadType = AudioClipLoadType.DecompressOnLoad;
                //压缩方式选择
                audioSetting.compressionFormat = AudioCompressionFormat.PCM;
            }else if (assetPath.Contains("Assets/GameMain/Asset/Sounds/CommonSounds"))
            {
                //加载方式选择
                audioSetting.loadType = AudioClipLoadType.DecompressOnLoad;
                //压缩方式选择
                audioSetting.compressionFormat = AudioCompressionFormat.PCM;
            }else if (assetPath.Contains("Assets/GameMain/Asset/Sounds/BattleSounds"))
            {
