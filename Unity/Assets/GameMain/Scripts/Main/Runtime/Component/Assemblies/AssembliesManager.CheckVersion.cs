...
public partial class AssembliesManager
{
    ...
    public void InitAssembliesVersion(OnInitAssembliesCompleteCallback onInitAssembliesCompleteCallback)
    {
        ...
        LoadBytes(Utility.Path.GetRemotePath(Path.Combine(GameEntryMain.Resource.ReadOnlyPath,FrameworkSettingsUtils.HybridCLRSettings.HybridCLRAssemblyPath, FrameworkSettingsUtils.HybridCLRSettings.AssembliesVersionTextFileName)), new LoadBytesCallbacks(OnLoadReadOnlyAssembliesVersionSuccess, OnLoadReadOnlyAssembliesVersionFailure), null);
    }
    ...
    public void CheckVersionList(CheckAssembliesVersionListCompleteCallback checkAssembliesVersionListComplete)
    {
        ...
        LoadBytes(Utility.Path.GetRemotePath(Path.Combine(GameEntryMain.Resource.ReadOnlyPath,FrameworkSettingsUtils.HybridCLRSettings.HybridCLRAssemblyPath, 
            FrameworkSettingsUtils.HybridCLRSettings.AssembliesVersionTextFileName)), new LoadBytesCallbacks(OnLoadReadOnlyAssembliesVersionSuccess, OnLoadReadOnlyAssembliesVersionFailure), null);
        LoadBytes(Utility.Path.GetRemotePath(Path.Combine(GameEntryMain.Resource.ReadWritePath,FrameworkSettingsUtils.HybridCLRSettings.HybridCLRAssemblyPath, 
            FrameworkSettingsUtils.HybridCLRSettings.AssembliesVersionTextFileName)), new LoadBytesCallbacks(OnLoadReadWriteAssembliesVersionSuccess, OnLoadReadWriteAssembliesVersionFailure), null);
    }
    ...
    private void FindUpdateAssemblies()
    {
        ...
        foreach (var assemblyInfo in m_ReadWriteAssemblies)
        {
            ...
            filePath = Path.Combine(GameEntryMain.Resource.ReadWritePath,FrameworkSettingsUtils.HybridCLRSettings.HybridCLRAssemblyPath,assemblyInfo.PathRoot,$"{assemblyInfo.Name}{FrameworkSettingsUtils.HybridCLRSettings.AssemblyAssetExtension}");
