...
public static class AGameMainConstantUI 
{

    private static Dictionary<EUIFormId, ConstantUI.UIFormInfo> uiForms = new Dictionary<EUIFormId, ConstantUI.UIFormInfo>()
    {
        {EUIFormId.UILoginForm, new ConstantUI.UIFormInfo(ConstantUI.EUIFormType.MainForm,"AGameMainExample","UILoginForm",ConstantUI.EUIGroupName.Background,false,true)},
        {EUIFormId.UIGameMainGamePlayForm, new ConstantUI.UIFormInfo(ConstantUI.EUIFormType.MainForm,"AGameMainExample","UIGameMainGamePlayForm",ConstantUI.EUIGroupName.Background,false,true)},
    };
