...
/*--------------------Auto generate end button listener.Do not modify!----------------------*/
        ...
        protected override void OnOpen(object userData)
        {
            ...
            if (form.IsSolo)
            {
                List<cfg.GameMain.UIData_GameMode> dataList = GameEntry.Config.Tables.TbUIData_GameMode.DataList.GetRange(0, 3);
            ...
            {
                List<cfg.GameMain.UIData_GameMode> dataList = GameEntry.Config.Tables.TbUIData_GameMode.DataList.GetRange(3, 2);
                for (int i = 0; i < dataList.Count; i++)
                {
                    m_GameModeDataList.Add(new UIGameModeItemDatat(dataList[i].Bg, dataList[i].Icon, dataList[i].Title, dataList[i].GameIndex));
                }
