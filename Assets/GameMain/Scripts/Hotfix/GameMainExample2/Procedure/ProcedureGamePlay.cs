    ...
    public class ProcedureGamePlay : ProcedureBase
    {
        ...
        protected override void OnEnter(ProcedureOwner procedureOwner)
        {
            ...
            if (!IsResume)
            {
                ...
                //2. ����NPC ---------------------------
                //2.1 ��EXCEL �л�ȡ����, �������ݴ��� NPC
                List<cfg.GameMain.EntityData> entityDataList = GameEntry.Config.Tables.TbEntityData.DataList;
				...
				for (int i = 0; i < levelDataList.Count; i++)
                {
                    ...
                    {
                        case 0:  //Զ��NPC
							cfg.GameMain.EntityData ed = entityDataList[levelDataList[i].EntityId];
