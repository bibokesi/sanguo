...
{
    [CreateAssetMenu(fileName = "SpriteCollection", menuName = "GameMain/Sprite Collection", order = 20)]
#if ODIN_INSPECTOR
...
#region UNITY_EDITOR
        ...
        protected override void OnBeforeSerialize()
        {
            ...
            {
                m_AtlasFolder = GameMainSettingsUtils.GameMainPathConfig.AtlasFolder;
            }
        }
