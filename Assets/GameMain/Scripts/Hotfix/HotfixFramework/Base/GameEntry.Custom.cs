...
public partial class GameEntry
{
    ...
    {
        GameEntryMain.Resource.LoadAsset("Assets/GameMain/BaseAssets/Prefabs/Customs/Customs.prefab", new LoadAssetCallbacks(LoadAssetSuccessCallback,LoadAssetFailureCallback));
    }
    ...
    {
        if (GameObject.Find("GameFramework/Customs") != null)
        {
            Resource.UnloadAsset(asset);
            return;
        }
        GameObject gameObject = UnityEngine.Object.Instantiate((GameObject)asset, GameObject.Find("GameFramework").transform, true);
