...
public static class Logger
{
        ...
        switch (logLevel)
        {
            case LogLevel.DEBUG:
                ...
                m_StringBuilder.Append(
                    $"<color={m_NameColor}><b>[GAMEMAIN] ► </b></color><color=#{GetColor(ColorType.gray)}><b>[DEBUG] ► </b> {logString}</color>" +
                    logString1);
                break;
            case LogLevel.INFO:
                logString1 = logStrings.Length > 1
                    ...
                    : "";
                m_StringBuilder.Append(
                    $"<color={m_NameColor}><b>[GAMEMAIN] ► </b></color><color=#{GetColor(ColorType.white)}><b>[INFO] ► </b> {logString}</color>" +
                    logString1);
                break;
            case LogLevel.ASSERT:
                logString1 = logStrings.Length > 1
                    ...
                    : "";
                m_StringBuilder.Append(
                    $"<color={m_NameColor}><b>[GAMEMAIN] ► </b></color><color=#{GetColor(ColorType.green)}><b>[ASSERT] ► </b> {logString}</color>" +
                    logString1);
                break;
            case LogLevel.WARNING:
                logString1 = logStrings.Length > 1
                    ...
                    : "";
                m_StringBuilder.Append(
                    $"<color={m_NameColor}><b>[GAMEMAIN] ► </b></color><color=#{GetColor(ColorType.yellow)}><b>[WARNING] ► </b> {logString}</color>" +
                    logString1);
                break;
            case LogLevel.ERROR:
                logString1 = logStrings.Length > 1
                    ...
                    : "";
                m_StringBuilder.Append(
                    $"<color={m_NameColor}><b>[GAMEMAIN] ► </b></color><color=#{GetColor(ColorType.orangered)}><b>[ERROR] ► </b> {logString}</color>");
                break;
            case LogLevel.FATAL:
                logString1 = logStrings.Length > 1
                    ...
                    : "";
                m_StringBuilder.Append(
                    $"<color={m_NameColor}><b>[GAMEMAIN] ► </b></color><color=#{GetColor(ColorType.violet)}><b>[FATAL] ► </b> {logString}</color>" +
                    logString1);
                break;
        }
    ...
    private static bool OnOpenAsset(int instanceID, int line)
    {
        ...
        if (!string.IsNullOrEmpty(stackTrace) && stackTrace.Contains("[GAMEMAIN]"))
        {
            ...
            while (matches.Success)
            {
                ...
                if (!pathLine.Contains("Logger.cs") && !pathLine.Contains("GameMainLogHelper.cs") &&
