...
namespace GameMain.Editor
{
    public class OverrideUIComponent
    {
        ...
        static TextMeshProUGUI CreateText()
        {
            ...
            text.font = AssetDatabase.LoadAssetAtPath<TMP_FontAsset>($"Assets/GameMain/AssetsPkg/Font/{GameMainSettingsUtils.GameMainGlobalSettings.DefaultFont}.asset"); // 默认字体  
