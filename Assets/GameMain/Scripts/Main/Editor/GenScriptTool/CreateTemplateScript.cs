...
{
    //脚本模板路径
    private const string TemplateScriptPath = "Assets/GameMain/Scripts/Main/Editor/GenScriptTool/Template/MyTemplateScript.cs.txt";
    private const string TemplateMainUIFormScriptPath = "Assets/GameMain/Scripts/Main/Editor/GenScriptTool/Template/MyTemplateMainUIFormScript.cs.txt";
    private const string TemplateBusinessUIFormScriptPath = "Assets/GameMain/Scripts/Main/Editor/GenScriptTool/Template/MyTemplateBusinessUIFormScript.cs.txt";
    private const string TemplateProcedureScriptPath = "Assets/GameMain/Scripts/Main/Editor/GenScriptTool/Template/MyTemplateProcedureScript.cs.txt";
    //菜单项
    [MenuItem("Assets/GameMain/C# Script", false, 1)]
    ...
    [MenuItem("Assets/GameMain/C# MainUIScript", false, 2)]
    ...
    [MenuItem("Assets/GameMain/C# BusinessUIScript", false, 3)]
    ...
    [MenuItem("Assets/GameMain/C# ProcedureScript", false, 4)]
